...
<div class="card flex-row flex-wrap">
  ...
  <div class="card-block px-2">
    <h4 class="card-title">
      <a href="https://www.medicalnewstoday.com${link}">
        ${title}
      </a>
    </h4>
    ...
    <div class="buttons">
      <button type="button" class="btn btn-success" data-id="${_id}" data-toggle="modal"
        data-target='#notesModal'>Article Notes</button>
    </div>
  </div>
  <div class="w-100"></div>
